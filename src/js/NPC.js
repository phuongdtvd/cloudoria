...
function NPC(x,y,key, npcId = null){
    ...
    this.tile = Game.computeTileCoords(this.x, this.y);
    Game.collisionArray[this.tile.y][this.tile.x] = 1; // So that you have to walk around NPC
